...
const builtInThemes: ThemeConfig[] = [
  ...
  },
  {
    ...
    label: 'Закат',
    icon: '🌅',
    description: 'Тёплая тема в оттенках заката',
    variables: {
      '--c-bg-default': '#fff8f0',
      '--c-bg-subtle': '#ffffff',
      '--c-bg-elevated': '#fff1e6',
      '--c-text-primary': '#8b4513',
      '--c-text-secondary': '#cd853f',
      '--c-text-inverse': '#ffffff',
      '--c-border': '#f4c2c2',
      '--c-border-focus': '#ff8a65',
      '--c-accent': '#ff8a65',
      '--c-accent-hover': '#ff7043',
      '--c-accent-active': '#d84315',
      '--c-success': '#4caf50',
      '--c-error': '#f44336',
      '--c-warning': '#ff9800',
      '--c-info': '#2196f3',
  ...
  },
  {
    ...
    variables: {
      '--c-bg-default': '#1a0f0f',
      '--c-bg-subtle': '#2a1a1a',
      '--c-bg-elevated': '#3a2525',
      '--c-text-primary': '#e8d0d0',
      '--c-text-secondary': '#c0a0a0',
      '--c-text-inverse': '#000000',
      '--c-border': '#4a2a2a',
      '--c-border-focus': '#bf3a55',
      '--c-accent': '#bf3a55',
      '--c-accent-hover': '#903f5c',
      '--c-accent-active': '#7a3a64',
      '--c-success': '#22c55e',
      '--c-error': '#d64b4b',
      '--c-warning': '#e26a29',
      '--c-info': '#632b58',
